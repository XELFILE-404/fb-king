...
redmi=[]
try:
 print('\033[32;1m𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 ARZEN TOOLS')
...
def banner():
  ...
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} Arzen Ramos Crescent             {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H} Arzen            {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+639168364596          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/arzen-tools{N}    {H}  ║
  {H}  ║{P}[{H}•{P}] Status    : {H}PREMIUM {P}     {N}      {H}     ║
   ...
   {M} ╚════════════════════════════════════════╝ {P}""")
    print(f"""{GREEN}    𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 ARZEN TOOLS{P}
